...
export const metadata = {
  title: 'EHR & Practice Management Integrations | Aethera Healthcare Solutions',
...
const featuredEHRs = [
  { name: 'Epic', initials: 'EP', type: 'Hospital & Ambulatory', method: 'HL7 FHIR API', setup: '3–4 weeks', note: 'Full bidirectional integration: charge capture, eligibility, claim status, and ERA posting.' },
  { name: 'Oracle Cerner', initials: 'CR', type: 'Hospital', method: 'HL7 2.x / FHIR', setup: '3–4 weeks', note: 'Charge Router integration with real-time claim scrubbing and ERA reconciliation.' },
  { name: 'athenahealth', initials: 'AT', type: 'Ambulatory PM', method: 'Native API', setup: '1–2 weeks', note: 'One of our most seamless integrations — charges flow automatically, no manual export needed.' },
  { name: 'eClinicalWorks', initials: 'EC', type: 'Ambulatory PM', method: 'Direct Interface', setup: '2–3 weeks', note: 'Full charge import with provider, location, and fee schedule mapping.' },
  { name: 'Kareo / Tebra', initials: 'KA', type: 'Small Practice PM', method: 'CSV / API', setup: '1–2 weeks', note: 'Ideal for solo and small group practices. Simple setup, immediate charge flow.' },
  { name: 'NextGen Healthcare', initials: 'NG', type: 'Ambulatory', method: 'HL7 Interface', setup: '2–3 weeks', note: 'Strong modifier and code set support. Denial data feeds back into NextGen automatically.' },
  { name: 'DrChrono', initials: 'DC', type: 'Mobile-First PM', method: 'REST API', setup: '1–2 weeks', note: 'Built for mobile-heavy practices. Real-time charge submission from any device.' },
  { name: 'Modernizing Medicine (EMA)', initials: 'MM', type: 'Specialty-Focused', method: 'Direct Export', setup: '2–3 weeks', note: 'Specialty-specific charge sheets supported. Particularly strong for dermatology and orthopedics.' },
  { name: 'Practice Fusion', initials: 'PF', type: 'Cloud PM', method: 'CCD / API', setup: '1–2 weeks', note: 'Simple charge export integration. Eligibility verification feeds back into the scheduler.' },
  { name: 'CharmHealth', initials: 'CH', type: 'Cloud PM', method: 'REST API', setup: '1–2 weeks', note: 'Full eligibility, claims, and ERA integration. Works well for multi-specialty groups.' },
  { name: 'Allscripts / Veradigm', initials: 'AL', type: 'Ambulatory', method: 'HL7 Interface', setup: '2–3 weeks', note: 'Legacy system expertise included. We handle the technical lift so your staff doesn\'t have to.' },
  { name: 'Meditech', initials: 'MT', type: 'Hospital', method: 'HL7 ADT / ORM', setup: '3–4 weeks', note: 'Full inpatient and outpatient support. Integrated with MEDITECH Expanse and legacy versions.' },
];
            ...
            {featuredEHRs.map((ehr, i) => (
              <FadeIn key={i} delay={(i % 4) * 0.1}>
                <div className="bg-white rounded-xl p-6 border border-gray/10 shadow-sm h-full flex gap-5">
                  <div className={`${colorMap[i % colorMap.length]} text-white rounded-xl w-12 h-12 flex items-center justify-center font-bold text-sm flex-shrink-0`}>
                    {ehr.initials}
                  </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <FadeIn delay={0.2}>
              <div className="bg-cream rounded-2xl p-8 border border-gray/10">
                ...
                <Link href="/contact" className="inline-flex items-center bg-teal hover:bg-navy text-white font-bold py-3 px-6 rounded-full transition-colors text-sm">
