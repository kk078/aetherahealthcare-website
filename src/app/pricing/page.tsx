...
const pricingPlans = [
  {
    ...
    features: [
      ...
      'End-to-end RCM: coding, scrubbing, posting & collections',
      'Dedicated account manager & AAPC-certified coders',
      'Aggressive denial appeals & timely AR follow-up',
      'Real-time portal analytics & monthly executive reporting',
    ],
    href: '/contact'
  },
  {
    ...
    features: [
      ...
      'Best for radiology, clinical labs, urgent care & diagnostics',
      'Automated claim scrubbing & clearinghouse electronic submission',
      'ERA/EOB payment posting & electronic deposit reconciliation',
      'Monthly volume reporting & payer exception logging',
      'Flexible volume scaling with no minimum penalty fees',
    ],
    href: '/contact'
  },
  {
    title: 'Flat Fee',
    price: 'Custom',
    description: 'Fixed monthly retainer for predictable practice budgeting.',
    features: [
      'Predictable recurring monthly overhead with no surprise invoices',
      'Best for established group practices with steady patient volumes',
      'Dedicated billing pod assigned directly to your EHR system',
      'Quarterly fee schedule analysis & payer contract review',
      'Priority 24/7 client support & dedicated account team',
      'SLA-backed turnaround times committed in writing',
    ],
    href: '/contact'
  },
  {
    title: 'Hybrid',
    price: 'Base + %',
    description: 'Lower fixed base plus performance bonus for shared upside.',
    features: [
      'Lower base overhead protects cash flow in slow periods',
      'Performance bonus aligned with exceeding clean-claim targets',
      'Complete full-cycle billing, denial appeals & patient statements',
      'Custom workflow integration for complex EHR multi-site setups',
      'Bi-weekly denial root-cause reviews with clinical leadership',
      'Contractually committed clean-claim & AR targets in writing',
    ],
    href: '/contact'
  }
];
