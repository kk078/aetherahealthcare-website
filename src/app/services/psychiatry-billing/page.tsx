...
export const metadata = {
  alternates: { canonical: canonicalUrl('/services/psychiatry-billing') },
  title: { absolute: 'Psychiatry & Behavioral Health Billing | RCM for Psychiatrists | Aethera Healthcare' },
