...
export const metadata: Metadata = {
  title: { absolute: '67 Free Medical Billing, EDI & RCM Tools | Aethera Healthcare' },
  description:
    '67 free tools for revenue cycle teams: adult congenital heart disease scrubber, pediatric facial reanimation scrubber, lateral skull base scrubber, pediatric airway LTR scrubber, and EDI parsers. No login required.',
};
  ...
  return (
    <div className="min-h-screen flex flex-col bg-[#fcfbf9]">
      ...
      <RcmHeroBand
        ...
        title="67 Free Medical Billing & RCM Tools"
        ...
        primary={{ href: '#tools', label: 'Explore All 67 Tools' }}
        secondary={{ href: '/free-assessment', label: 'Get a Free Practice Audit' }}
        chips={['67 Free Tools', 'No Login Required', 'Federal Statutory Compliance', 'Built by AAPC Coders']}
      />
