...
export const metadata: Metadata = {
  title: { absolute: '71 Free Medical Billing, EDI & RCM Tools | Aethera Healthcare' },
  description:
    '71 free tools for revenue cycle teams: pediatric craniosynostosis scrubber, robotic urologic oncology scrubber, pediatric EOS growing rod scrubber, cytoreductive surgery & HIPEC scrubber, and EDI parsers. No login required.',
};
  ...
  return (
    <div className="min-h-screen flex flex-col bg-[#fcfbf9]">
      ...
      <RcmHeroBand
        ...
        title="71 Free Medical Billing & RCM Tools"
        ...
        primary={{ href: '#tools', label: 'Explore All 71 Tools' }}
        secondary={{ href: '/free-assessment', label: 'Get a Free Practice Audit' }}
        chips={['71 Free Tools', 'No Login Required', 'Federal Statutory Compliance', 'Built by AAPC Coders']}
      />
