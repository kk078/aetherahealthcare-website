...
export const metadata: Metadata = {
  title: { absolute: '45 Free Medical Billing, EDI & RCM Tools | Aethera Healthcare' },
  description:
    '45 free tools for revenue cycle teams: cardiac EP scrubber, reconstructive prior-auth scrubber, radiation oncology, dialysis MCP calculator, FQHC PPS scrubber, ambulance fee calculator, MolDX Z-code scrubber, and EDI parsers. No login required.',
};
  ...
  return (
    <div className="min-h-screen flex flex-col bg-[#fcfbf9]">
      ...
      <RcmHeroBand
        ...
        title="45 Free Medical Billing & RCM Tools"
        ...
        primary={{ href: '#tools', label: 'Explore All 45 Tools' }}
        secondary={{ href: '/free-assessment', label: 'Get a Free Practice Audit' }}
        chips={['45 Free Tools', 'No Login Required', 'Federal Statutory Compliance', 'Built by AAPC Coders']}
      />
