...
export const metadata: Metadata = {
  title: { absolute: '75 Free Medical Billing, EDI & RCM Tools | Aethera Healthcare' },
  description:
    '75 free tools for revenue cycle teams: pediatric vascular malformations scrubber, orthopedic oncology mega-prosthesis scrubber, pediatric CDH & ECMO scrubber, complex FEVAR & TAAA aortic scrubber, and EDI parsers. No login required.',
};
  ...
  return (
    <div className="min-h-screen flex flex-col bg-[#fcfbf9]">
      ...
      <RcmHeroBand
        ...
        title="75 Free Medical Billing & RCM Tools"
        ...
        primary={{ href: '#tools', label: 'Explore All 75 Tools' }}
        secondary={{ href: '/free-assessment', label: 'Get a Free Practice Audit' }}
        chips={['75 Free Tools', 'No Login Required', 'Federal Statutory Compliance', 'Built by AAPC Coders']}
      />
