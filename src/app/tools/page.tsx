...
export const metadata: Metadata = {
  title: { absolute: '33 Free Medical Billing, EDI & RCM Tools | Aethera Healthcare' },
  description:
    '33 free tools for revenue cycle teams: Medicare Secondary Payer engine, clinical trial scrubber, CMS HCC RAF benchmarker, MIPS forecaster, denial overturn predictor, and EDI parsers. No login required.',
};
  ...
  return (
    <div className="min-h-screen flex flex-col bg-[#fcfbf9]">
      ...
      <RcmHeroBand
        ...
        title="33 Free Medical Billing & RCM Tools"
        ...
        primary={{ href: '#tools', label: 'Explore All 33 Tools' }}
        secondary={{ href: '/free-assessment', label: 'Get a Free Practice Audit' }}
        chips={['33 Free Tools', 'No Login Required', 'Federal Statutory Compliance', 'Built by AAPC Coders']}
      />
