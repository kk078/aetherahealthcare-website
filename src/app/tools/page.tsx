...
export const metadata: Metadata = {
  title: { absolute: '89 Free Medical Billing, EDI & RCM Tools | Aethera Healthcare' },
  description:
    '89 free tools for revenue cycle teams: pediatric TEF & esophageal atresia scrubber, DIEP flap breast reconstruction scrubber, pediatric SCT coccygectomy scrubber, adult retroperitoneal sarcoma scrubber, and EDI parsers. No login required.',
};
  ...
  return (
    <div className="min-h-screen flex flex-col bg-[#fcfbf9]">
      ...
      <RcmHeroBand
        ...
        title="89 Free Medical Billing & RCM Tools"
        ...
        primary={{ href: '#tools', label: 'Explore All 89 Tools' }}
        secondary={{ href: '/free-assessment', label: 'Get a Free Practice Audit' }}
        chips={['89 Free Tools', 'No Login Required', 'Federal Statutory Compliance', 'Built by AAPC Coders']}
      />
