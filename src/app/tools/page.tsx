...
export const metadata: Metadata = {
  title: { absolute: '35 Free Medical Billing, EDI & RCM Tools | Aethera Healthcare' },
  description:
    '35 free tools for revenue cycle teams: Surgical global period scrubber, DMEPOS validator, Medicare Secondary Payer engine, clinical trial scrubber, CMS HCC RAF benchmarker, and EDI parsers. No login required.',
};
  ...
  return (
    <div className="min-h-screen flex flex-col bg-[#fcfbf9]">
      ...
      <RcmHeroBand
        ...
        title="35 Free Medical Billing & RCM Tools"
        ...
        primary={{ href: '#tools', label: 'Explore All 35 Tools' }}
        secondary={{ href: '/free-assessment', label: 'Get a Free Practice Audit' }}
        chips={['35 Free Tools', 'No Login Required', 'Federal Statutory Compliance', 'Built by AAPC Coders']}
      />
