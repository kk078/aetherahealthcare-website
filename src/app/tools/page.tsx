...
export const metadata: Metadata = {
  title: { absolute: '69 Free Medical Billing, EDI & RCM Tools | Aethera Healthcare' },
  description:
    '69 free tools for revenue cycle teams: pediatric EOS growing rod scrubber, cytoreductive surgery & HIPEC scrubber, adult congenital heart disease scrubber, pediatric facial reanimation scrubber, and EDI parsers. No login required.',
};
  ...
  return (
    <div className="min-h-screen flex flex-col bg-[#fcfbf9]">
      ...
      <RcmHeroBand
        ...
        title="69 Free Medical Billing & RCM Tools"
        ...
        primary={{ href: '#tools', label: 'Explore All 69 Tools' }}
        secondary={{ href: '/free-assessment', label: 'Get a Free Practice Audit' }}
        chips={['69 Free Tools', 'No Login Required', 'Federal Statutory Compliance', 'Built by AAPC Coders']}
      />
