...
export const metadata: Metadata = {
  title: { absolute: '73 Free Medical Billing, EDI & RCM Tools | Aethera Healthcare' },
  description:
    '73 free tools for revenue cycle teams: pediatric CDH & ECMO scrubber, complex FEVAR & TAAA aortic scrubber, pediatric craniosynostosis scrubber, robotic urologic oncology scrubber, and EDI parsers. No login required.',
};
  ...
  return (
    <div className="min-h-screen flex flex-col bg-[#fcfbf9]">
      ...
      <RcmHeroBand
        ...
        title="73 Free Medical Billing & RCM Tools"
        ...
        primary={{ href: '#tools', label: 'Explore All 73 Tools' }}
        secondary={{ href: '/free-assessment', label: 'Get a Free Practice Audit' }}
        chips={['73 Free Tools', 'No Login Required', 'Federal Statutory Compliance', 'Built by AAPC Coders']}
      />
