  ...
  return (
    <div className="min-h-screen flex flex-col">
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              "description": "Learn about Aethera Healthcare Solutions' comprehensive compliance program including HIPAA, security practices, and privacy protection for healthcare providers.",
              "url": "https://aetherahealthcare.com/compliance",
              "publisher": {
                "@type": "Organization",
      ...
      <RcmHeroBand
        ...
        subtitle="A comprehensive compliance program ensuring the highest standards of data protection and regulatory adherence."
        primary={{ href: '/contact', label: 'Talk to Us' }}
        chips={['HIPAA-compliant', 'BAAs available', 'Regular audits']}
      />
