...
import IpfPpsArbiter from '@/components/ui/IpfPpsArbiter';
  ...
  return (
    <div className="min-h-screen flex flex-col font-inter">
      ...
      <main className="flex-1">
        ...
        {/* Section 3V: Inpatient Psychiatric Facility Prospective Payment System (IPF PPS) & ECT Arbiter */}
        <IpfPpsArbiter />

        {/* Section 3W: Sovereign Coder vs Autonomous AI Live Adjudication Benchmark Arena */}
