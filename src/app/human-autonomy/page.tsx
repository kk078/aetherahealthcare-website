  ...
  return <div className="min-h-screen bg-[#FAFCFB] text-slate-800">
    ...
    <main id="main-content">
      ...
      <div className="mx-auto max-w-6xl space-y-20 px-6 py-16">
        <section className="rounded-2xl border border-teal-200 bg-teal-50 p-7"><h2 className="text-2xl font-semibold text-slate-950">The interactive anatomy atlas has its own home.</h2><p className="mt-3 max-w-3xl leading-relaxed text-slate-700">Explore the 3D human body, isolate anatomical structures and study documentation checkpoints across 40 specialty learning paths.</p><Link href="/anatomy-atlas/" className="mt-5 inline-block rounded-lg bg-[#0B2545] px-5 py-3 font-semibold text-white">Open the 3D anatomy atlas →</Link></section>
