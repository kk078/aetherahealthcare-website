...
================================================================================
  ...
  const handleLeadSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (!(await sendLeadToKiran('pediatric_craniosynostosis_rcm_audit', payload))) { setIsSubmitting(false); return; }
            ...
            <div className="grid grid-cols-1 gap-2.5">
              {[
                ...
                <button
                  key={item.id}
                  type="button"
                  onClick={() => setSurgicalApproach(item.id as typeof surgicalApproach)}
